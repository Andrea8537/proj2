...
function checkCol(col){
  ...
  return true;
  // board[0][col].innerText===current_player&&board[1][col].innerText===current_player&&board[2][col].innerText===current_player;
}
...
function checkDia(){
  var diagnal1 = board[0][0].innerHTML === current_player&&board[1][1].innerHTML === current_player&&board[2][2].innerHTML ===current_player;
  var diagnal2 = board [0][2].innerHTML===current_player&&board [1][1].innerHTML ===current_player&&board[2][0].innerHTML ===current_player;
